...
const DrawerWrapper: React.FunctionComponent<DrawerWrapperProps> = ({
  ...
  return (
    <div className="relative flex h-full flex-col bg-white">
      {!hideTopBar && (
        <div className=" absolute top-0 z-30 mb-4 flex h-16 w-full items-center justify-end  border-b border-border-200 border-opacity-75 px-5 start-0 md:mb-6 md:py-5 md:px-8">
