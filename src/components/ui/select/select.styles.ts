...
if (typeof window !== 'undefined') {
  ...
  // Handle the case where window is not available (e.g., during SSR or build)
  currentUrl = ''; // Set a default value or handle it accordingly
}
...
export const selectStyles = {
  ...
  control: (_: any, state: any) => ({
    display: 'flex',
    alignItems: 'center',
    minHeight: currentUrl==='/bookings/booking'?'20px':'50px',
