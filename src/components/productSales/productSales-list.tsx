...
const UnitList = (list: any) => {
  ...
  const columns = [
    {
      title:<span style={{fontFamily:"poppins"}}>{t('table:sku')}</span> ,
      className: 'cursor-pointer',
      dataIndex: 'productSku',
      key: 'name',
      align: alignLeft,
      // onHeaderCell: () => onHeaderClick('name'),
      render: (sku: any) => <span className="whitespace-nowrap" style={{fontFamily:"poppins"}}>{sku}</span>,
    },
    {
      title:<span style={{fontFamily:"poppins"}}>{t('table:table-item-item')}</span> ,
      className: 'cursor-pointer',
      dataIndex: 'productName',
      key: 'name',
      align: alignLeft,
      // onHeaderCell: () => onHeaderClick('name'),
      render: (productName: any) => (
        <span className="whitespace-nowrap " style={{fontFamily:"poppins"}}>{productName}</span>
      ),
    },
    {
      title:<span style={{fontFamily:"poppins"}}>{t('table:table-item-category')}</span> ,
      className: 'cursor-pointer',
      ...
      render: (categoryName: any) => (
        <span className="whitespace-nowrap" style={{fontFamily:"poppins"}}>{categoryName}</span>
      ),
    },
    {
      title:<span style={{fontFamily:"poppins"}}>{t('table:table-item-sold-item')}</span> ,
      className: 'cursor-pointer',
      dataIndex: 'itemsold',
      key: 'name',
      align: 'center',
      // onHeaderCell: () => onHeaderClick('name'),
      render: (itemsold: any) => (
        <span className="whitespace-nowrap" style={{fontFamily:"poppins"}}>{itemsold}</span>
      ),
    },
    {
