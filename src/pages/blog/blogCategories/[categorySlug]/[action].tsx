...
import CreateOrUpdateCategoriesForm from '@/components/blog/blogCategory/category-form';
...
export default function UpdateCategoriesPage() {
  ...
  useEffect(() => {
    setloadingData(true);
    GetSpecificFunction('/get-blog-category', query.categorySlug as string).then(
      (result) => {
        if (result) {
